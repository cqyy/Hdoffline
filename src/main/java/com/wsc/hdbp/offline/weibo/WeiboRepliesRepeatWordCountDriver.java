...
import com.wsc.hdbp.offline.weibo.WeiboRepliesRepeatWordCount.RedisKeyWordsMapper;

public class WeiboRepliesRepeatWordCountDriver extends Configured implements Tool {
	...
	public int run(String[] arg0) throws Exception {
		...
		// 第二阶段 - 词频分析
		Job job2 = new Job(conf, "RepliesRepeat_To_Keywords");
		job2.setJarByClass(WeiboRepliesRepeatWordCount.class);
		...
		RedisOutputFormatForHash.setRedisSelection(job2, RedisSelection.WEIBO_REPLIES_REPEAT.index());
	...
	public static void main(String[] args) throws Exception{
		ToolRunner.run(new WeiboRepliesRepeatWordCountDriver(), args);
	}
